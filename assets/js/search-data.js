...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "CV",
          description: "Curriculum Vitae of Zhongyang YU. You can also download the PDF version from the top-right button.",
          section: "Navigation",
          handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("/assets/pdf/YZY_short_CV.pdf", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
